...
Revision ID: 8043034a6937
Revises: 
Create Date: 2021-10-24 17:47:02.995480
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('client_exercise_time', sa.Integer(), nullable=False),
    sa.Column('client_total_time', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.PrimaryKeyConstraint('time_id', 'client_id')
    )
